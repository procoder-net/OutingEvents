...
export async function addEventParticipant(
    ...
    return await connectORM.getRepository(EventParticipant).save(eventParticipant);
}
...
export function getEventParticipants(event_id: number, id?: number, populateRelations = true): any {
    let find: any = {
        event: event_id
    };
    if (id) {
